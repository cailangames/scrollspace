...
const uint8_t tips[] = {
  ...
  CHAR_N, CHAR_O, CHAR_SPACE, CHAR_P, CHAR_I, CHAR_C, CHAR_K, CHAR_U, CHAR_P, CHAR_S, CHAR_SPACE, CHAR_I, CHAR_N, CHAR_SPACE, CHAR_SPACE, CHAR_SPACE, CHAR_S, CHAR_H, CHAR_I, CHAR_E, CHAR_L, CHAR_D, CHAR_SPACE, CHAR_SPACE, CHAR_SPACE, 
